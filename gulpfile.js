/*von gulp-scale-images npm Dokumentation übernommen */
...
function defaultTask(cb) {
    const twoVariantsPerFile = (file, cb) => {
        ...
        cb(null, [jpegFile, jpegFile2, jpegFile3,jpegFile4, jpegFile5,
            webpFile, webpFile2, webpFile3, webpFile4, webpFile5])
    }

    return gulp.src('img/**/*.{jpeg,jpg}')       //geht auf images Ordner und holt sich dann alle direkten Dateien und Dateien in Unterordnern
